...
// Formula for the calculation of the value of 𝝌²: counts[i] = observed value in each bin; exp = expected value for each bin (constant in this case)
...
// MEAN VALUE AND VARIANCE (WITH CORRESPECTRIVE UNCERTAINTIES) CALCULATION
   ...
   // Initialization of the vectors to be used in the calculation of mean values and uncertanties
...
// 𝝌² CALCULATION (FOR A UNIFORM DISTRIBUTION)
   ...
   double N_bins = 100;                      // Number of bins
