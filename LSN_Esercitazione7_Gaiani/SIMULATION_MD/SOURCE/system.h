...
private:
  ...
  bool _therma;         // Flag indicating if we want thermalization for the Ising model to take place
...
public: // Function declarations
  ...
  bool get_therma();           // If therma == true, the system undergoes thermalization
  void set_temp(double);       // Allows to change the temperature in the main file
