...
private:
  ...
  bool _reverse = false;   // Flag to reverse r_{n} and r_{n-1} when performing Reverse_Verlet
...
public: // Function declarations
  ...
  void ReverseVerlet();       // Perform Verlet integration step back in time
  ...
  void BeginReverseOnce();    // Swap r_{n} and r_{n-1} before performing ReverseVerlet
};
